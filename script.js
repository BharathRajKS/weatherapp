...
function getWeather() 
{
    ...
    function checkWeather(city)
    {
        ...
        .then(data => {
            ...
            windSpeed.innerHTML =`<i class="fa-solid fa-wind wind"></i> `+`<br>`+data.wind.speed + "m/s" ;
...
function updateBackground(temp) {
    ...
    if (temp > 26) {
        main_div.style.backgroundImage = 'url("weather img 1.png")';
    } else if (temp >= 20 && temp <= 25) {
        main_div.style.backgroundImage = 'url("weather img 2.png")';
    } else {
        main_div.style.backgroundImage = 'url("weather img 3.webp")';
    }
}
